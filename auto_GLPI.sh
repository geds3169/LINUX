...
# Prevent error command not found
...
/sbin/adduser www-data $user_name
...
wget -P /root/tmp/ https://files.phpmyadmin.net/phpMyAdmin/5.2.1/phpMyAdmin-5.2.1-all-languages.tar.gz
mkdir -p /var/www/phpmyadmin
cd /root/tmp/
tar xvf phpMyAdmin-5.2.1-all-languages.tar.gz --strip-components=1 -C /var/www/phpmyadmin
...
wget -P /tmp/ https://github.com/glpi-project/glpi/releases/download/10.0.2/glpi-10.0.2.tgz
mkdir -p /var/www/glpi
cd /tmp/
tar xvf glpi-10.0.2.tgz --strip-components=1 -C /var/www/glpi

chown -R www-data /var/www/

################################
# Write glpi.conf for apache
################################
...
<VirtualHost *:80>
    ...
    Alias /projecta /var/www/glpi
    Alias /projectb /var/www/phpmyadmin
...
echo "Please open http://127.0.0.1/glpi"
echo "Please open http://127.0.0.1/phpmyadmin"
